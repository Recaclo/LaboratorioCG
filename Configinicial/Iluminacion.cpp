...
// Ilustracion de Materiales e Iluminacion
// 2 de Abri de 2026
// Previo 8
// 320015764
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.30f, 0.20f, 0.20f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.specular"), 0.20f, 0.20f, 0.20f);
        ...
        glm::mat4 model(1.0f);
        model = glm::translate(model, glm::vec3(-1.5f, -1.0f, -8.0f));
        ...
        model2 = glm::translate(model2, glm::vec3(2.0f, -1.5f, -10.0f));
